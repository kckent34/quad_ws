...
class ImuData(genpy.Message):
  _md5sum = "4bcffd395c379630a20bafde314d282e"
...
string frame_id
"""
  __slots__ = ['header','theta','phi','psi','theta_dot','phi_dot','psi_dot','psi_gyro_integration','dt','succ_read']
  _slot_types = ['std_msgs/Header','float32','float32','float32','float32','float32','float32','float32','float32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,theta,phi,psi,theta_dot,phi_dot,psi_dot,psi_gyro_integration,dt,succ_read
