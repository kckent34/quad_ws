...
"""autogenerated by genpy from quad_msgs/SonarData.msg. Do not edit."""
import sys
...
class SonarData(genpy.Message):
  _md5sum = "3646bd231f5033c4af083bc617838d04"
  _type = "quad_msgs/SonarData"
...
string frame_id
"""
  __slots__ = ['header','x_pos','x_neg','y_pos','y_neg','up','down']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,x_pos,x_neg,y_pos,y_neg,up,down
