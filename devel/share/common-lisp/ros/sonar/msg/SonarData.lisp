...
(cl:defmethod cl:initialize-instance :after ((m <SonarData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SonarData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sonar-msg:<SonarData> is deprecated: use sonar-msg:SonarData instead.")))

(cl:ensure-generic-function 'x_pos-val :lambda-list '(m))
(cl:defmethod x_pos-val ((m <SonarData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar-msg:x_pos-val is deprecated.  Use sonar-msg:x_pos instead.")
  (x_pos m))

(cl:ensure-generic-function 'x_neg-val :lambda-list '(m))
(cl:defmethod x_neg-val ((m <SonarData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar-msg:x_neg-val is deprecated.  Use sonar-msg:x_neg instead.")
  (x_neg m))

(cl:ensure-generic-function 'y_pos-val :lambda-list '(m))
(cl:defmethod y_pos-val ((m <SonarData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar-msg:y_pos-val is deprecated.  Use sonar-msg:y_pos instead.")
  (y_pos m))

(cl:ensure-generic-function 'y_neg-val :lambda-list '(m))
(cl:defmethod y_neg-val ((m <SonarData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar-msg:y_neg-val is deprecated.  Use sonar-msg:y_neg instead.")
  (y_neg m))

(cl:ensure-generic-function 'up-val :lambda-list '(m))
(cl:defmethod up-val ((m <SonarData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar-msg:up-val is deprecated.  Use sonar-msg:up instead.")
  (up m))

(cl:ensure-generic-function 'down-val :lambda-list '(m))
(cl:defmethod down-val ((m <SonarData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sonar-msg:down-val is deprecated.  Use sonar-msg:down instead.")
  (down m))
