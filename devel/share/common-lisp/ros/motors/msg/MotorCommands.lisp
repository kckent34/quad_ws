...
(cl:defmethod cl:initialize-instance :after ((m <MotorCommands>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorCommands)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name motors-msg:<MotorCommands> is deprecated: use motors-msg:MotorCommands instead.")))

(cl:ensure-generic-function 'm0-val :lambda-list '(m))
(cl:defmethod m0-val ((m <MotorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motors-msg:m0-val is deprecated.  Use motors-msg:m0 instead.")
  (m0 m))

(cl:ensure-generic-function 'm1-val :lambda-list '(m))
(cl:defmethod m1-val ((m <MotorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motors-msg:m1-val is deprecated.  Use motors-msg:m1 instead.")
  (m1 m))

(cl:ensure-generic-function 'm2-val :lambda-list '(m))
(cl:defmethod m2-val ((m <MotorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motors-msg:m2-val is deprecated.  Use motors-msg:m2 instead.")
  (m2 m))

(cl:ensure-generic-function 'm3-val :lambda-list '(m))
(cl:defmethod m3-val ((m <MotorCommands>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader motors-msg:m3-val is deprecated.  Use motors-msg:m3 instead.")
  (m3 m))
