...
(cl:defmethod joy_des_angles-val ((m <XbeeData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xbee-msg:joy_des_angles-val is deprecated.  Use xbee-msg:joy_des_angles instead.")
  (joy_des_angles m))

(cl:ensure-generic-function 'joy_thrust-val :lambda-list '(m))
(cl:defmethod joy_thrust-val ((m <XbeeData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xbee-msg:joy_thrust-val is deprecated.  Use xbee-msg:joy_thrust instead.")
  (joy_thrust m))

(cl:ensure-generic-function 'flight_mode-val :lambda-list '(m))
(cl:defmethod flight_mode-val ((m <XbeeData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xbee-msg:flight_mode-val is deprecated.  Use xbee-msg:flight_mode instead.")
  (flight_mode m))
