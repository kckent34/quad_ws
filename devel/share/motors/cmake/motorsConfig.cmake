...
if("TRUE" STREQUAL "TRUE")
  set(motors_SOURCE_PREFIX /home/odroid/quad_ws/src/motors)
  set(motors_DEVEL_PREFIX /home/odroid/quad_ws/devel)
  set(motors_INSTALL_PREFIX "")
  set(motors_PREFIX ${motors_DEVEL_PREFIX})
else()
  set(motors_SOURCE_PREFIX "")
  set(motors_DEVEL_PREFIX "")
  set(motors_INSTALL_PREFIX /home/odroid/quad_ws/install)
...
if(NOT "/home/odroid/quad_ws/devel/include;/home/odroid/quad_ws/src/motors/include " STREQUAL " ")
  set(motors_INCLUDE_DIRS "")
  set(_include_dirs "/home/odroid/quad_ws/devel/include;/home/odroid/quad_ws/src/motors/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'motors' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'odroid <odroid@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'motors' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/quad_ws/src/motors/${idir}'.  Ask the maintainer 'odroid <odroid@todo.todo>' to fix it.")
    endif()
